...
export default function EditAssetForm({ familyId, asset, onAssetUpdated }: EditAssetFormProps) {
    ...
    const onSubmit = async (data: AssetFormData) => {
        try {
            await updateAsset(familyId, asset.id, data);
            toast({ title: "Success", description: "Asset updated successfully." });
            onAssetUpdated();
        } catch (error) {
            console.error("Error updating asset: ", error);
            toast({ title: "Error", description: "Could not update asset. Please try again.", variant: "destructive" });
        }
    };
